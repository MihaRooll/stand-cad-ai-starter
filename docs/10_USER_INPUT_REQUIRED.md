...
**Current placement (D-089 / D-084, 2026-08-08):** `hardware.handle_mount_y_mm` = **181.3 mm** (loaded-case balance-point CoM Y — live recomputation within `tolerance.part_assembly_feature_mm`; D-089 cycle 3 retune after +11 mm stack; supersedes D-084 **180.6 mm**, D-074 **179.8 mm**, and D-063 **185.9 mm**); `hardware.handle_mount_z_mm` = **263 mm** (D-089 +11 mm stack; was 252 at D-084/D-058). TZ:304 grip cutout (110×35 mm) on the right side slab (`PANEL-OUT-RIGHT-001`): grip band **Y ≈ [126.3, 236.3] mm**, **Z ≈ [245.5, 280.5] mm**.

**Tier-2 finger intrusion (OPEN blocker):** at Y=181.3 / Z=263 the through-cutout grip volume intersects the tier-2 plotter bay (`EQUIP-PLOTTER2-001`, Cameo 5 **124 mm** body) by **≈1,502,833.5 mm³** (`handle_finger_intrusion_volume_mm3`, `tests/test_geometry.py::test_handle_tier2_finger_intrusion_at_balance_point`). Tier-1 plotter finger intrusion is **0 mm³**. Service-port aft margin **≈30.7 mm** (port Y=275); cable entry (Y=320, Ø30) nearest edge **≈68.7 mm** aft of grip band.
...
Until one option is chosen and modelled, the §E through-cutout intersecting the tier-2 bay by **≈1.50×10⁶ mm³** (1,502,833.5 mm³ at current Y=181.3 / Z=263) blocks a production-ready side-panel release. Tracked in `state/DEFERRED_VERIFICATION.md` (D-050/D-051 row).

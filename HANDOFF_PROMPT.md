...
| Tip-over | Baseline indicative (split-mass, D-039/D-077): lower **3.828** @250 mm; upper **N/A** (`upper_extension`=0, D-076/D-077). PLT-010 **`IN_PROGRESS`** — adversarial lean **1.434** (<1.5); dual-tray **0.924** historical (pre-D-076 both-tier extend); **NOT authoritative for Gate G4** |
| Mass | Headline structural **9.651 kg**; all-parts **13.445 kg**; indicative fasteners **162** (158 registry + 4 FOOT M4; `base_clad_m3`=0 per D-069); STACK-CAP **≈0.118 kg** (4×0.0294). Stability model includes joining roll-up (A-017). ≤12 kg structural ceiling met indicatively — PLT-012 **`IN_PROGRESS`**, not Gate G4 authoritative. |
...
4. **Mass (PLT-012 `IN_PROGRESS`)** — structural **9.651 kg** (indicative; ≤12 kg ceiling met but not Gate G4 authoritative); indicative fasteners **162** (158 registry + 4 FOOT M4); all-parts **13.445 kg**; STACK-CAP **≈0.118 kg**.
5. **Tip-over qualified review (PLT-010 `IN_PROGRESS`)** — baseline rev15 lower **3.828** @250 mm; upper **N/A** (D-076/D-077); lean **1.434** (<1.5); dual-tray **0.924** historical (pre-D-076) — Gate G4 needs engineering review (`docs/10_USER_INPUT_REQUIRED.md` §K/§L).
